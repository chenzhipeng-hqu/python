...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Box0_checkBox_2 = QtWidgets.QCheckBox(self.gridLayoutWidget_2)
        self.Box0_checkBox_2.setEnabled(True)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.Box0_checkBox_2.setFont(font)
        self.Box0_checkBox_2.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.Box0_checkBox_2.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.Box0_checkBox_2.setChecked(False)
        self.Box0_checkBox_2.setAutoRepeat(False)
        self.Box0_checkBox_2.setTristate(False)
        self.Box0_checkBox_2.setObjectName("Box0_checkBox_2")
        self.gridLayout_3.addWidget(self.Box0_checkBox_2, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.Box0_checkBox_2.setText(_translate("Form", "ALL"))
